...
run-numadisttest: numadisttest
	$(QEMU) -machine q35,nto64-per-cpu-ram=on,nto64-numa-distance=40 \
	    -smp 2 -m 128 \
...
run-cxltest: cxltest
	$(QEMU) -machine q35,nto64-per-cpu-ram=on,cxl=on,cxl-fmw.0.targets.0=cxl.0,cxl-fmw.0.size=512M,cxl-fmw.0.interleave-granularity=256 \
	    -m 2G -smp 2 \
